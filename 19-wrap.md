...
quanto sia sciatto il tuo pensiero" Lo stesso vale per la programmazione: molte cose che sembrano ovvie quando ci pensiamo si rivelano tutt'altro quando dobbiamo spiegarle con precisione.
...
- [SciPy](https://scipy.org) è una ricca collezione di utilità scientifiche. È anche il nome di [una serie di conferenze annuali](https://conference.scipy.org/).
...
- Stack Overflow [sezione generale su
  Python](https://stackoverflow.com/questions/tagged/python?tab=Votes) può essere utile, così come le sezioni su
